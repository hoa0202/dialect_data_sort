        ...
        if file_path[-4:] == "json" and f[0] != ".":
            with open (file_path, "r", encoding="utf-8") as json2:
                ...
                for speakerInfo in json_data["speaker"]:
                    ...
                    healthCondition = speakerInfo["healthCondition"]
                    if healthCondition == None :
                        print("null")
                    # print(file_path)
                    speakerId_and_healthCondition.append([speakerId, healthCondition])

#print(dict(speakerId_and_residencePeriod))
a = dict(speakerId_and_healthCondition)
